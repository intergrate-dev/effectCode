...
Source Database       : finance-service

Target Server Type    : MYSQL
Target Server Version : 50724
File Encoding         : 65001

Date: 2020-11-04 10:10:37
*/
...
CREATE TABLE `auth_company` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='企业表';

-- ----------------------------
-- Table structure for auth_comp_attachment
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='企业附件表';

-- ----------------------------
-- Table structure for auth_comp_extend
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_comp_open_bank
-- ----------------------------
...
CREATE TABLE `auth_comp_open_bank` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='企业银行账户表';

-- ----------------------------
-- Table structure for auth_comp_recode
-- ----------------------------
...
CREATE TABLE `auth_comp_recode` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='企业认证记录表';

-- ----------------------------
-- Table structure for auth_comp_stockh
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_finance_org
-- ----------------------------
...
CREATE TABLE `auth_finance_org` (
  ...
  `actual_office_addr` varchar(255) DEFAULT NULL COMMENT '实际办公地址',
  `latest_inspect_msg` varchar(255) DEFAULT NULL COMMENT '最新年检信息',
  `change_msg` varchar(255) DEFAULT NULL COMMENT '企业变更登记信息',
  `cancel_msg` varchar(255) DEFAULT NULL COMMENT '企业注销信息',
  `person_size` char(2) DEFAULT NULL COMMENT '企业人员规模:0 50人以下,1 50人以下,2  500至2000人,3 2000人以上',
  `reg_addr` varchar(255) DEFAULT NULL COMMENT '注册地址,企业住所',
...
-- ----------------------------
-- Table structure for auth_finance_org_attachment
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_finance_org_extend
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_finance_org_open_bank
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_finance_org_stockh
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_finan_operorg_recode
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_finan_org_recode
-- ----------------------------
...
CREATE TABLE `auth_finan_org_recode` (
  ...
  `auth_fail_reason` varchar(255) DEFAULT NULL COMMENT '认证失败原因',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='金融机构认证记录表';

-- ----------------------------
-- Table structure for auth_gov_org
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_indiv_attachment
-- ----------------------------
...
CREATE TABLE `auth_indiv_attachment` (
  ...
  `legal_person_credit_report` varchar(255) DEFAULT NULL COMMENT '法定代表人（实际控制人）人行征信报告',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='个体户企业附件表';

-- ----------------------------
-- Table structure for auth_indiv_extend
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_indiv_househ
-- ----------------------------
...
CREATE TABLE `auth_indiv_househ` (
  ...
  `credit_report_url` varchar(255) DEFAULT NULL COMMENT '（平台）信用报告文件url地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='个体户企业表';

-- ----------------------------
-- Table structure for auth_indiv_open_bank
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_indiv_recode
-- ----------------------------
...
CREATE TABLE `auth_indiv_recode` (
  ...
  `auth_fail_reason` varchar(255) DEFAULT NULL COMMENT '认证失败原因',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='个体户认证记录表';

-- ----------------------------
-- Table structure for auth_operorg_attachment
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_operorg_extend
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_operorg_open_bank
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_operorg_stockh
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_oper_org
-- ----------------------------
...
-- ----------------------------
-- Table structure for auth_regulator_org
-- ----------------------------
...
-- ----------------------------
-- Table structure for finance_need_comp
-- ----------------------------
...
-- ----------------------------
-- Table structure for finance_need_invid
-- ----------------------------
...
-- ----------------------------
-- Table structure for finance_order_comp
-- ----------------------------
...
CREATE TABLE `finance_order_comp` (
  ...
  `comp` bigint(20) DEFAULT NULL COMMENT '对接机构id',
...
-- ----------------------------
-- Table structure for finance_order_invid
-- ----------------------------
...
CREATE TABLE `prod_finance_product` (
  ...
  `pro_case` varchar(255) DEFAULT NULL COMMENT '案例',
  `spec_explain` varchar(255) DEFAULT NULL COMMENT '特此说明',
  `province` varchar(255) DEFAULT NULL COMMENT '省',
  `city` varchar(255) DEFAULT NULL COMMENT '市',
  `county` varchar(255) DEFAULT NULL COMMENT '县/区',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='金融产品表';
